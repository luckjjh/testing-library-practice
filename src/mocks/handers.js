...
const data = [
    ...
    },
    {
        ...
        "TimeZone": {
            ...
            "GmtOffset": -4.0,
            "IsDaylightSaving": false,
            "NextOffsetChange": "2022-09-04T04:00:00Z"
        },
        "GeoPosition": {
            "Latitude": -33.446,
            "Longitude": -70.659,
    ...
    },
    {
        ...
        "TimeZone": {
            ...
            "GmtOffset": -5.0,
            "IsDaylightSaving": true,
            "NextOffsetChange": "2022-10-30T07:00:00Z"
        },
        "GeoPosition": {
            "Latitude": 19.433,
            "Longitude": -99.133,
    ...
    },
    {
        ...
        "TimeZone": {
            ...
            "GmtOffset": 10.0,
            "IsDaylightSaving": false,
            "NextOffsetChange": "2022-10-01T16:00:00Z"
        },
        "GeoPosition": {
            "Latitude": -33.87,
            "Longitude": 151.209,
    ...
    },
    {
        ...
        "TimeZone": {
            ...
            "GmtOffset": -4.0,
            "IsDaylightSaving": true,
            "NextOffsetChange": "2022-11-06T05:00:00Z"
        },
        "GeoPosition": {
            "Latitude": 23.117,
            "Longitude": -82.389,
    ...
    },
    {
        ...
        "TimeZone": {
            ...
            "GmtOffset": 4.5,
            "IsDaylightSaving": true,
            "NextOffsetChange": "2022-09-21T19:30:00Z"
        },
        "GeoPosition": {
            "Latitude": 35.701,
            "Longitude": 51.407,
...
export const handlers = [
    rest.get("https://apidev.accuweather.com/locations/v1/topcities/50.json?apikey=207002a5564d447292dac501ce2f71ac",(req, res, ctx)=>{
        return res(
            ctx.status(200),
            ctx.json(data),
        )
